...
//uint8_t* mydata = NULL;
//mydata = (uint8_t*)malloc(strlen("\"device\":\"Aeronodo\",\"temperatura\":\"88888\",\"humedad\":\"88888\",\"lux\":\"88888\",\"pH\":\"888888\"") + 1);
//strcpy((char*)mydata, "\"device\":\"Aeronodo\",\"temperatura\":\"88888\",\"humedad\":\"88888\",\"lux\":\"88888\",\"pH\":\"888888\"");

static uint8_t mydata[] = "\"device\":\"Aeronodo\",\"temperatura\":\"88888\",\"humedad\":\"88888\",\"lux\":\"88888\",\"pH\":\"888888\"";
//int mydata_new_size = strlen((char*)mydata) + 1;
    ...
    switch(sen_st){
      ...
      case MEAN:
        ...
        if(count <= c){
          ...
          /*mydata_new_size = snprintf(NULL, 0, "\"temperatura\":\"%.2f\",\"humedad\":\"%.2f\",\"lux\":\"%.2f\",\"pH\":\"%.2f\"", t_mean, h_mean, lux_mean, ph_mean) + 1;
          Serial.println(mydata_new_size);
          realloc(mydata, mydata_new_size);
          if (mydata == NULL){
            Serial.print("Data handling error");
          }
          snprintf((char*)mydata, mydata_new_size, "\"temperatura\":\"%.2f\",\"humedad\":\"%.2f\",\"lux\":\"%.2f\",\"pH\":\"%.2f\"", t_mean, h_mean, lux_mean, ph_mean);*/
