...
//static const u1_t PROGMEM APPEUI[8] = { 0x00, 0x77, 0x66, 0x55, 0x44, 0x33, 0x22, 0x11 }; // indoor PUJ
...
//static const u1_t PROGMEM APPKEY[16] = { 0x11, 0x11, 0x22, 0x22, 0x33, 0x33, 0x44, 0x44, 0x55, 0x55, 0x66, 0x66, 0x77, 0x77, 0x88, 0x88 }; // indoor PUJ
void os_getDevKey(u1_t* buf) { memcpy_P(buf, APPKEY, 16); }

//static uint8_t mydata[] = "\"deviceID\":\"Aeronodo\",\"temperatura\":\"88888\",\"humedad\":\"88888\",\"lux\":\"88888\",\"pH\":\"88888\"";
static uint8_t mydata[] = "\"device\":\"Aeronodo1\",\"temperatura\":\"888888\",\"humedad\":\"888888\",\"lux\":\"88888888\",\"pH\":\"88888\"";
    ...
    switch(sen_st){
      ...
      case MEAN:
        ...
        if(count <= c){
          ...
          sprintf((char*)mydata,"\"device\":\"Aeronodo1\",\"temperatura\":\"%06.2f\",\"humedad\":\"%06.2f\",\"lux\":\"%08.2f\",\"pH\":\"%05.2f\"", t_mean, h_mean, lux_mean, ph_mean);
          sen_st = SEND_DATA;
        }
        break;
      case SEND_DATA:
