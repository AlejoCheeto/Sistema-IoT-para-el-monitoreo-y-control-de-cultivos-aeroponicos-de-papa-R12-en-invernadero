...
float ph_val = 5.32;
float lux_val = 100.0;
float sourceVoltage = 12.34;
float sourceCurrent = 0.56;
float batteryVoltage = 11.11;
float batteryCurrent = 0.23;

static uint8_t mydata[] = "\"deviceID\":\"Aeronodo\",\"temperatura\":\"38.24\",\"humedad\":\"56.4\",\"lux\":\"65.78\",\"pH\":\"6.45\"";
